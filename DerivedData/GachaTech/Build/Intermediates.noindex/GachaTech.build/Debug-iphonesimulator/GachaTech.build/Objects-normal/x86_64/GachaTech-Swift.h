...
#ifndef GACHATECH_SWIFT_H
#define GACHATECH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GachaTech",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9GachaTech11AppDelegate")
...
SWIFT_CLASS("_TtC9GachaTech20ResultViewController")
@interface ResultViewController : UIViewController
@property (nonatomic, strong) IBOutlet UIImageView * _Null_unspecified haikeiImageView;
@property (nonatomic, strong) IBOutlet UIImageView * _Null_unspecified monsterImageView;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC9GachaTech13SceneDelegate")
...
SWIFT_CLASS("_TtC9GachaTech14ViewController")
